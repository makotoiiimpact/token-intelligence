# Contributing to Token Intelligence

Thanks for considering a contribution! Token Intelligence is a small, stdlib-only Python project — easy to run, easy to change. Forked from the upstream open-source [token-dashboard](https://github.com/nateherkai/token-dashboard); IIIMPACT additions are noted in CLAUDE.md § New modules.
